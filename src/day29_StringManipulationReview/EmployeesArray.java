...
public class EmployeesArray {
    public static void main(String[] args) {
        ...
        for (String eachEmployee:employees) {
            String job = eachEmployee.substring(eachEmployee.indexOf("[")+1,eachEmployee.indexOf("]"));
            System.out.println("job = " + job);
            String fullname  = eachEmployee.substring(eachEmployee.indexOf(0)+1,eachEmployee.indexOf("["));
